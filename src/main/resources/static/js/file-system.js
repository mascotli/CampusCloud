...
function createFolderNode(folderID, show) {
    ...
    $.ajax({
        ...
        url: "http://localhost:8080/CampusCloud/api/v1/users/"+sessionStorage.getItem("user_username")+"/disk/folders/"+folderID+"?sort="+sortType,
        /* 
...
function mkfolder() {
    ...
    function confirm() {
        ...
        if (localName.length == 0) {
            ...
            $.ajax({
                type: "POST",
                url: "http://localhost:8080/CampusCloud/api/v1/users/"+sessionStorage.getItem("user_username")+"/disk/folders",
...
function getRecycleItems(){
    $.ajax({
        type: "GET",
        url: "http://localhost:8080/CampusCloud/api/v1/users/"+sessionStorage.getItem("user_username")+"/disk/folders/3?sort=1",
        contentType: "application/json; charset=utf-8",
        success: function(result) {
...
function getFile(type) {
    ...
    $.ajax({
        type: "GET",
        url: "http://localhost:8080/CampusCloud/api/v1/users/"+sessionStorage.getItem("user_username")+"/"+ type,
        contentType: "application/json; charset=utf-8",
        success: function(result){
            var files = result.files;
            var node = $('<ul></ul>');
